...
public class ImagemTeste extends javax.swing.JFrame {
 ...
 MouseEvent pressed;
    ...
    public ImagemTeste() {
        initComponents();
         DisplayPanel dis = new DisplayPanel(new File("C:\\Users\\breno.melo\\Desktop\\Nova pasta\\LEO.pdf"), false);
            DisplayPanel dis2 = new DisplayPanel(new File("C:\\Users\\breno.melo\\Desktop\\Nova pasta\\TABLET10.PDF"),true);
//         DisplayPanel dis2 = new DisplayPanel(new File("C:\\Users\\breno.melo\\Desktop\\Nova pasta\\telessaude.jpg"));
//         DisplayPanel dis3 = new DisplayPanel(null);
//          p1.setBackground(new Color(0,0,0,125));
         dis2.setBackground(new Color(0,0,0,5));
         dis.setBackground(new Color(0,0,0,5));
//         dis2.setSize(900, 600);
//         painelTeste.add(dis2);
         painelTeste.setVisible(false);
//         painelTeste.add(dis);
//         movimentar(painelTeste);
//         painelTeste.setBackground(new Color(0,0,0,80));
