...
//          if (e.getSource() == p)
    ...
    public void setCorMedida(Color corMedida) {
...
//        repaint();
    ...
    class Medida {
        ...
        public String toString() {
            ...
            return String.format("Tamanho: %4.2f  - Proporção: %4.2f", med, med / calcularMedida(x, y, curX, curY));
        }
