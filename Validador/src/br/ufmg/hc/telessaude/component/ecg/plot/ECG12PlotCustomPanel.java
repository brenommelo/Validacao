...
public class ECG12PlotCustomPanel extends javax.swing.JPanel {//implements KeyListener {
    ...
    public ECG12PlotCustomPanel(ConteudoECG12 conteudoECG12, String identificacao) {
...
//            }
        ...
        public void mouseDragged(MouseEvent e) {
            if (pressed != null && pressed.getButton() == MouseEvent.BUTTON1) {
                pPoint = ECG12PlotCustomPanel.this.getLocation(pPoint);
                int x = pPoint.x - pressed.getX() + e.getX();
                int y = pPoint.y - pressed.getY() + e.getY();
                ECG12PlotCustomPanel.this.setLocation(x, y);
