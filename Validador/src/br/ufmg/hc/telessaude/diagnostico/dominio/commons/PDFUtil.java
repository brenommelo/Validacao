...
public class PDFUtil extends PDF {
    ...
    public PDFUtil(Exame exame, int scale, float speed, boolean printGrid) throws PDFException {
...
//        }
        ...
        for (int i = 0; i < conteudos.size(); i++) {
            printTracing((CONTEUDOEXAME) conteudos.get(i), exame.getPaciente().getNome(), exame.getDatarealizacao(), scale, speed, printGrid);
        }
    ...
    public PDFUtil(String str, boolean printGrid) throws PDFException {
//        Gson gson = new Gson();
//        Exame exame = gson.fromJson(str, Exame.class);
        ...
        /////--- desenha tra�ado no pdf
        for (int i = 0; i < conteudos.size(); i++) {
            printTracing((CONTEUDOEXAME) conteudos.get(i), exame.getPaciente().getNome(), exame.getDatarealizacao(), 10, 25, printGrid);
        }
