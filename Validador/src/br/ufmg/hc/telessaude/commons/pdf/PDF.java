...
public class PDF extends PdfPageEventHelper {
    ...
    protected void printTracing(CONTEUDOEXAME conteudo, String nomePaciente, Date date, int scale, float speed, boolean printGrid) {
        ...
        for (int register = 0; register < printProtocolo.getRegisters(); register++) {
            ...
            Graphics2D graphics;
            graphics = printProtocolo.print(template, document.getPageSize(), register, date, scale, speed, sampling, printGrid);
